...
export class Drink extends Component{
    componentWillMount(){
        this.props.actions.fetchDrinkById(this.props.params.drink);
        this.props.actions.fetchAllComments(this.props.params.drink);
    }
    addToFavourites(e){
        e.preventDefault();
        const data = {
    ...
    render(){
        const drink = this.props.alcos.drink;
