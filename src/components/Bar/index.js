...
export class Bar extends Component{
    componentWillMount(){
        this.props.actions.fetchBarById(this.props.params.bar);
        this.props.actions.fetchAllComments(this.props.params.bar);
    }
    addToFavourites(e){
        e.preventDefault();
        const data = {
    ...
    render(){
        const drink = this.props.alcos.bar;
        ...
        return(
            <div className='drink-cont'>
                ...
                <hr/>
                <div className={'drinkPhoto'} style={{'backgroundImage': `url(${drink.photo})`}}>
                </div>
                <div className={'drink-text'}>
                    <p>Name: {drink.name}</p>
                    <p>Address: {drink.address}</p>
                    <p>Phone: {drink.phone}</p>
                    <p>Working hours: {drink.workingHours}</p>
